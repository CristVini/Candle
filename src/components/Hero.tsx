  ...
  return (
    <header className="relative h-screen flex flex-col items-center justify-center px-4 text-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-[-20%] left-[-10%] w-[120%] h-[120%] bg-stone-800/10 rounded-full blur-[120px] animate-pulse"></div>
      </div>
      ...
      <div className="w-full max-w-6xl mx-auto space-y-8 md:space-y-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-4 pt-8 px-4">
          <button 
            onClick={onStartQuiz}
            className="group relative w-full sm:w-auto inline-flex items-center justify-center px-10 py-5 bg-stone-100 text-stone-950 rounded-full font-bold text-base md:text-lg transition-all hover:bg-white hover:scale-105 active:scale-95 shadow-2xl"
          >
            Começar Mapeamento
          </button>
