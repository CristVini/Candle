...
export const candleProfiles: Record<string, CandleProfile> = {
  burnout: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1594498653385-d5172b532c00?q=80&w=1000&auto=format&fit=crop',
  ...
  hopelessness: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1557844352-761f2565b576?q=80&w=1000&auto=format&fit=crop',
  ...
  acute_stress: {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1595981266686-0cf387d0a608?q=80&w=1000&auto=format&fit=crop',
